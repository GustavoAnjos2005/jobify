  ...
  return (
    ...
    duration-300 border-gray-500 rounded-lg border-opacity-10'>
        <div className='flex items-center space-x-4'>
            ...
            {/* content */}
            <div>
                <h1 className='text-[17px] font-semihold mb-[0.4rem]'>{category}</h1>
                <p className='text-[14px] text-black font-semibold text-opacity-50'>({openPosition} Cargos Abertos)</p>
            </div>
        </div>
    </div>
  )

...
const Nav = async() => {
  ...
  return ( <div className='h-[13vh] overflow-hidden shadow-md'>
    <div className='w-[90%] md:w-[80%] h-[100%] mx-auto flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-4'>
            ...
            { session && (
            <button className='px-4 py-1.5 text-[14px] sm:text-[16px] sm:px-6 sm:py-2 bg-orange-600 font-semibold text-white rounded-lg hover:orange-blue-800 transition-all duration-300'>
                    Oferta de Emprego
                </button>
                )}
        </div>
